...
/*
 Below we have the class Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context 
 to "this", and save the instance to a variable named animal1.  You can pass anything you want in for name, species and food.
*/
...
//Code Here
const animal1 = new Animal ("Johnny", "dolphin", "fish");
...
/*
  here we have a function that just returns the "this" keyword.  We will give context to "this", 
